...
def dts_rach_graphs(kmax):
    ...
    for i in K:
        ...
        ratessic.append(ratesic*100)
        transmssic.append(transmsic)
        sra_rates.append(sra_rate*100)
    ...
    plt.ylim(0, 0.4)
    plt.xlim(5000, 50000)
    plt.plot(K, throughputssic, label='Динамический+SIC', marker=".", linewidth=2, markersize=7)
    plt.plot(K, throughputs, label='Динамический', marker=".", linewidth=2, markersize=7)
    plt.plot(K, sra_thrs_paper, label='Стандартный ALOHA', marker=".", linewidth=2, markersize=7, linestyle='--')
    plt.plot(K, TA_6_thr, label='Фиксированный, q=6', marker=".", linewidth=2, markersize=7)
    plt.plot(K, TA_9_thr, label='Фиксированный, q=9', marker=".", linewidth=2, markersize=7)
    plt.plot(K, TA_18_thr, label='Фиксированный, q=18', marker=".", linewidth=2, markersize=7)
    # plt.plot(K, ta_18_delays, label='q-ary, q=18 theory', marker=".", linewidth=2, markersize=7)
    plt.xlabel('Количество устройств')
    plt.ylabel('Средняя скорость подключения')
    plt.grid(True)
    plt.legend()
    plt.show()
    ...
    # plt.ylim(0, 1600)
    # plt.xlim(5000, 50000)
    plt.plot(K, delayssic, label='Динамический+SIC', marker=".", linewidth=2, markersize=7)
    plt.plot(K, delays, label='Динамический', marker=".", linewidth=2, markersize=7)
    plt.plot(K, sra_delays, label='Стандартный ALOHA', marker=".", linewidth=2, markersize=7, linestyle='--')
    plt.plot(K, TA_6_delay, label='Фиксированный, q=6', marker=".", linewidth=2, markersize=7)
    plt.plot(K, TA_9_delay, label='Фиксированный, q=9', marker=".", linewidth=2, markersize=7)
    plt.plot(K, TA_18_delay, label='Фиксированный, q=18', marker=".", linewidth=2, markersize=7)
    ...
    # plt.ylim(0, 1)
    # plt.xlim(5000, 50000)
    plt.plot(K, ratessic, label='Динамический+SIC', marker=".", linewidth=2, markersize=7)
    plt.plot(K, rates, label='Динамический', marker=".", linewidth=2, markersize=7)
    plt.plot(K, sra_rates, label='Стандартный ALOHA', marker=".", linewidth=2, markersize=7, linestyle='--')
    plt.plot(K, ta_6_rate, label='Фиксированнный, q=6', marker=".", linewidth=2, markersize=7)
    plt.plot(K, ta_9_rate, label='Фиксированнный, q=9', marker=".", linewidth=2, markersize=7)
    plt.plot(K, ta_18_rate, label='Фиксированнный, q=18', marker=".", linewidth=2, markersize=7)
    plt.xlabel('Количество устройств')
    plt.ylabel('Процент успешных устройств')
    plt.grid(True)
    plt.legend()
    plt.show()
    ...
    plt.ylim(0, 10)
    plt.xlim(5000, 50000)
    plt.plot(K, transmssic, label='Динамический+SIC', marker=".", linewidth=2, markersize=7)
    plt.plot(K, transms, label='Динамический', marker=".", linewidth=2, markersize=7)
    plt.plot(K, sra_transm, label='Стандартный ALOHA', marker=".", linewidth=2, markersize=7, linestyle='--')
    plt.plot(K, TA_6_transm, label='Фиксированный, q=6', marker=".", linewidth=2, markersize=7)
    plt.plot(K, TA_9_transm, label='Фиксированный, q=9', marker=".", linewidth=2, markersize=7)
    plt.plot(K, TA_18_transm, label='Фиксированный, q=18', marker=".", linewidth=2, markersize=7)
    plt.xlabel('Количество устройств')
    plt.ylabel('Среднее кол-во передач')
    plt.grid(True)
    plt.legend()
    plt.show()
